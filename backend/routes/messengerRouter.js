const { getFriends, sendMessage, getMessage, sendImage, seenAll, getTargetUser, addRequest, getRequest, addFriend, addMoment } = require('../controller/messengerController');
...
router.post('/add-moment', authMiddleware, addMoment);
